  ...
  return (
    <section className="Card">
      ...
      >
        ...
        {data.Title && <div className="h5">{data?.Title}</div>}
        {data.Description && (
          <article
    ...
    icon: (
      ...
      >
        ...
        >
          ...
          <g
            id="Group_31201"
            data-name="Group 31201"
            transform="translate(19.14 23.743)"
          >
            <g
              id="Group_31200"
              data-name="Group 31200"
              clipPath="url(#clip-path)"
            >
              <path
                id="Path_16153"
                data-name="Path 16153"
                d="M18.706,41.037H14.678a.751.751,0,0,1-.78-.78v-8.9A6.5,6.5,0,0,0,7.792,24.8,6.372,6.372,0,0,0,1.1,31.162v15.4a3.563,3.563,0,0,0,3.573,3.573h7.991a.751.751,0,0,1,.78.78V59.1a2.773,2.773,0,0,0,2.794,2.794h3.573A2.773,2.773,0,0,0,22.6,59.1V45a3.844,3.844,0,0,0-3.9-3.963"
                transform="translate(-0.385 -8.683)"
                fill="#e9d8e8"
              />
              <path
                id="Path_16154"
                data-name="Path 16154"
                d="M7.147,0A7.147,7.147,0,1,1,0,7.147,7.147,7.147,0,0,1,7.147,0"
                fill="#e9d8e8"
              />
              <path
                id="Path_16155"
                data-name="Path 16155"
                d="M75.9,24.8a6.377,6.377,0,0,0-6.367,6.367V40.2a.751.751,0,0,1-.78.78H64.728A4.048,4.048,0,0,0,60.7,45.005V59.168a2.773,2.773,0,0,0,2.794,2.794h3.573a2.773,2.773,0,0,0,2.794-2.794V50.982a.751.751,0,0,1,.78-.78h7.991A3.563,3.563,0,0,0,82.2,46.629V31.167A6.281,6.281,0,0,0,75.9,24.8"
                transform="translate(-21.264 -8.688)"
                fill="#e9d8e8"
              />
              <path
                id="Path_16156"
                data-name="Path 16156"
                d="M80.147,0A7.147,7.147,0,1,1,73,7.147,7.147,7.147,0,0,1,80.147,0"
                transform="translate(-25.573)"
                fill="#e9d8e8"
              />
              <path
                id="Path_16157"
                data-name="Path 16157"
                d="M53.662,40.614A2.024,2.024,0,0,0,51.648,38.6H28.714a2.014,2.014,0,0,0,0,4.028H38.2V64.912a2.014,2.014,0,1,0,4.028,0V42.628h9.485a2.012,2.012,0,0,0,1.949-2.014"
                transform="translate(-9.353 -13.522)"
                fill="#e9d8e8"
              />
              <path
                id="Path_16158"
                data-name="Path 16158"
                d="M36.718,30.365a.838.838,0,0,0,.769.577H48.353a.806.806,0,0,0,.769-.577l2.212-7.4a.846.846,0,0,0-.1-.674A.685.685,0,0,0,50.661,22H35.276a.685.685,0,0,0-.577.288.846.846,0,0,0-.1.674Z"
                transform="translate(-12.108 -7.707)"
                fill="#e9d8e8"
              />
            </g>
          </g>
    ...
    icon: (
      ...
      >
        ...
        >
          ...
          <g
            id="Group_31199"
            data-name="Group 31199"
            transform="translate(23.757 18.445)"
          >
            <g
              id="Group_31199-2"
              data-name="Group 31199"
