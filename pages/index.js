    ...
    <main>
...

      {
        ...
        >
          ...
          }
          {
            ...
            <article
              dangerouslySetInnerHTML={{__html: md().render(post?.ShowcaseSecond?.Description)}}
        ...
        <section className="bg-[#FFF7E5] py-12 xl:py-24">
          <div className="wrapper flex flex-col space-y-6 items-center justify-center">
            ...
            }
            {
              ...
              <article
                dangerouslySetInnerHTML={{ __html: md().render(post?.ShowcaseThird?.Description) }}
...

      {
        ...
        <section className="bg-[#FCEADF] py-12 xl:py-24">
          ...
          {
            (post?.Slideshow?.Slideshow && post?.Slideshow?.Slideshow?.length > 0) &&
  ...
  return (
    ...
    >
      ...
      <div className="lg:w-7/12 flex flex-col items-start space-y-6">
        {
          data?.Title &&
          <div className="h3 capitalize">{data?.Title}</div>
        }
        {
          data?.Description &&
            <article
      ...
      >
        {
          ...
          <figure className="relative aspect-square">
            <ImageWidth data={data?.Image?.data?.attributes} dbtable="homepage" />
          </figure>
        }
