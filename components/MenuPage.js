   ...
   return (
      <main className="flex-grow bg-[url('/bg_menu.jpg')]">
         ...
         <aside className="ParentCategory flex flex-col justify-between bg-primary-100">
            ...
            <Link href="/menu" className="btn-secondary mx-4 mb-4">Show All</Link>
         </aside>
         <main
         ...
         >
            {
               ...
               <Link
                  ...
                  href={item.attributes.Slug ? `/menu/${item.attributes.Slug}` : '/menu'}
               >
                  <span
         ...
         </section>
         {
            ...
            <section className="flex justify-center items-center h-80 my-24 w-auto">
               <div className="flex flex-col space-y-4 items-center">
                  ...
                  <Link className="btn-secondary mx-4 mb-4" href="/menu">Show All</Link>
               </div>
            </section>
         }
      </main>
